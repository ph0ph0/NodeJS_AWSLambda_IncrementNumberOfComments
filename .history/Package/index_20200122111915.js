...
exports.handler = (event, context, callback) => {
  ...
  try {
    ...
    //By passing non-null as the second argument, we tell the lambda not to retry.
    //Otherwise, it will retry endlessly for 24 hours. Including error in first argument
    //ensures that the error is logged in cloud watch.
